import type { Issue, IssueCreate, IssueUpdate, IssuePriority, IssueStatus } from "./types";

const API_BASE = "http://localhost:8000/api/v1/issues";

export const api = {
  async getIssues(filters?: { status?: IssueStatus; priority?: IssuePriority }): Promise<Issue[]> {
